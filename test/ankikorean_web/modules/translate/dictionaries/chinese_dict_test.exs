  ...
  describe "Test our little chinese dictionary" do
    ...
    test "Get the translation for 荷蘭人", %{} do
      assert_value ChineseDict.translate("荷蘭人") ==
                     "He2 - Holland/the Netherlands/abbr. for 荷蘭|荷兰[He2 lan2] AND he2 - lotus AND he4 - to carry on one's shoulder or back/burden/responsibility AND Lan2 - surname Lan/abbr. for Lanzhou 蘭州|兰州[Lan2 zhou1], Gansu AND lan2 - orchid (蘭花|兰花 Cymbidium goeringii)/fragrant thoroughwort (蘭草|兰草 Eupatorium fortunei)/lily magnolia (木蘭|木兰) AND ren2 - man/person/people/CL:個|个[ge4],位[wei4]"
    end

    test "Get the translation for 陌生人", %{} do
      assert_value ChineseDict.translate("陌生人") ==
                     "mo4 sheng1 ren2 - stranger"
    end
    ...
    test "Get the translation for 氣象廳 with wrong characters", %{} do
      ...
      assert_value ChineseDict.translate("氣象廳xx") ==
                     "qi4 - gas/air/smell/weather/to make angry/to annoy/to get angry/vital energy/qi AND xiang4 - elephant/CL:隻|只[zhi1]/shape/form/appearance/to imitate AND ting1 - (reception) hall/living room/office/provincial government department"
    end
